...
class Net(nn.Module):
    """
    DCNN is a deep convolutional neural network (DCNN) for one-dimensional signals.
    It is a generalization of the CNN for one-dimensional signals.
    The architecture of DCNN is similar to CNN, but the convolutional layers are replaced by deep convolutional layers.
    The deep convolutional layers are implemented by the same architecture as the CNN.
    """
    def __init__(self, vgg_name, in_channels=1, n_class=5, use_feature=False):
        """
        :param vgg_name: name of the DCNN architecture
        :param in_channels: number of input channels
        :param n_class: number of output classes
        :param use_feature: if True, return the features of the last convolutional layer
        """
    ...
    def _make_layers(self, cfg):
        """
        :param cfg: list of layer configurations
